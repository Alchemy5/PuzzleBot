...
square_sdf_uri = (assets_dir / "square.sdf").resolve().as_uri()
...
- add_model:
    ...
    default_free_body_pose:
        cross_link:
            translation: {_format_vec(puzzle_center)}
            rotation: !Rpy {{ deg: [0, 0, 0] }}
- add_model:
    name: square_lower_right
    file: "{square_sdf_uri}"
- add_weld:
    parent: world
    child: square_lower_right::square_link
    X_PC:
        translation: {_format_vec(lower_right_square)}
        rotation: !Rpy {{ deg: [0, 0, 0] }}

- add_model:
    name: square_lower_left
    file: "{square_sdf_uri}"
- add_weld:
    parent: world
    child: square_lower_left::square_link
    X_PC:
        translation: {_format_vec(lower_left_square)}
        rotation: !Rpy {{ deg: [0, 0, 0] }}

- add_model:
    name: square_upper_left
    file: "{square_sdf_uri}"
- add_weld:
    parent: world
    child: square_upper_left::square_link
    X_PC:
        translation: {_format_vec(upper_left_square)}
        rotation: !Rpy {{ deg: [0, 0, 0] }}

- add_model:
    name: square_upper_right
    file: "{square_sdf_uri}"
- add_weld:
    parent: world
    child: square_upper_right::square_link
    X_PC:
        translation: {_format_vec(upper_right_square)}
        rotation: !Rpy {{ deg: [0, 0, 0] }}
